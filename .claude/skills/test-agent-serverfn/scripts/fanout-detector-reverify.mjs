// Verify deterministic multi-lane detector: fan-out on labeled list (main 9a77207), solo on single-topic.
// PRIMARY signal = WHO RESPONDS. TURN A (4-lane list) x2, TURN B (single-topic control).
...
console.log("\n======== TURN A · 4-LANE LIST (expect fan-out, NOT [solo]) ========");
