...
>(
  (
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-(--sidebar-width) bg-sidebar p-0 text-sidebar-foreground [&>button]:app-hidden"
            style={
              {
    ...
    return (
      <div
        ref={ref}
        className="group peer app-hidden text-sidebar-foreground md:block"
        data-state={state}
      ...
      >
        ...
        <div
          className={cn(
            "fixed inset-y-0 z-10 app-hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear md:flex",
            side === "left"
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "after:absolute after:-inset-2 after:md:app-hidden",
        "group-data-[collapsible=icon]:app-hidden",
        className,
      )}
      {...props}
    />
