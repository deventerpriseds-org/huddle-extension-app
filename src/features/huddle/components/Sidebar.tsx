...
function SidebarButton({
  ...
  return (
    ...
    >
      ...
      {showUnread && (
        <span className="ml-auto shrink-0 rounded-full bg-orange-600 px-1.5 py-0.5 text-center text-[10px] font-semibold leading-none text-white min-w-[1.125rem] dark:bg-blue-500 dark:text-white">
          {unread > 99 ? "99+" : unread}
        </span>
      )}
    </button>
